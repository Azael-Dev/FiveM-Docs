...
```
- **enable** = เปิดใช้งาน Queue สำหรับการตรวจสอบข้อมูลของผู้เล่น
- **limit** = จำนวนผู้เล่นสูงสุดต่อรอบ
- **refresh** = เวลาในการตรวจสอบ Queue สำหรับการตรวจสอบข้อมูลของผู้เล่น
- **vip** = VIP Queue ไม่ต้องรอ Queue สำหรับการตรวจสอบข้อมูลของผู้เล่น
	- **enable** = เปิดใช้งาน VIP Queue สำหรับการตรวจสอบข้อมูลของผู้เล่น
	- **identifier** = ระบุ Identifier ที่ไม่ต้องรอ Queue สำหรับการตรวจสอบข้อมูลของผู้เล่น

{{% alert theme="info" %}}
หากเปิดใช้งาน ตรวจสอบ R* License แทน Steam ให้ระบุ Identifier เป็น license
{{% /alert %}}
...
License ที่ต้องการขึ้นบัญชีดำ (จะไม่สามารถเชื่อมต่อกับเซิร์ฟเวอร์ได้)
...
- **enable** = เปิดใช้งาน License Blacklisted
- **license** = License ที่ต้องการขึ้นบัญชีดำ
